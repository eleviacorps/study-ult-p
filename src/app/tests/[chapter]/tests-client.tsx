          ...
          <div className="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto">
            ...
            <div className="space-y-3">
              {questions.map((q, i) => {
                ...
                const userText = userAns !== undefined && userAns !== null
                  ? (typeof userAns === "number" ? q.options[userAns] || "" : String(userAns))
                  : "Skipped";
                return (
        ...
        <div className="flex items-center justify-center min-h-[80vh] px-4">
          <div className="max-w-lg w-full glass p-8 text-center">
            ...
            <button onClick={() => setShowReview(true)}
              className="w-full py-2 mb-2 rounded-xl bg-[#8B5CF6]/10 border border-[#8B5CF6]/20 text-[#8B5CF6] text-xs hover:bg-[#8B5CF6]/20 transition-colors">
              Review Answers
            </button>
