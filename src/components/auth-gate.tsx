        ...
        >
          {(() => {
            ...
            if (status === "public" || shellless) {
              return <main className="app-main flex-1 h-full relative z-0 min-w-0">{children}</main>;
            }
            return (
              <>
                <Sidebar />
                <main className="app-main flex-1 h-full relative z-0 min-w-0">{children}</main>
              </>
            );
          })()}
        </motion.div>
